...
const MAX_FILE_SIZE = 5 * 1024 * 1024; // 5MB — matches the server-side limit in /api/resumes
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center">
        ...
        {photoError && <p className="text-[11.5px] font-semibold text-red-500 mt-1">{photoError}</p>}
...
function StepSkills({ form, setForm, errors }: StepProps) {
  ...
  const handleResumeFile = (file: File) => {
    const validType = file.type === "application/pdf" || file.name.endsWith(".doc") || file.name.endsWith(".docx");
    if (!validType) {
...
export default function SubmitResume() {
  ...
  // Builds the multipart payload and posts it to /api/resumes
  const submitResume = async () => {
    ...
    try {
      ...
      fd.append("workType", JSON.stringify(form.workType));
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              {!submitted && submitError && (
                <div className="px-8 -mt-4 pb-2">
                  <div className="flex items-center gap-2 bg-red-50 border border-red-100 text-red-600 text-[12.5px] font-semibold px-4 py-3 rounded-xl">
              ...
              {!submitted && (
                <div className="px-8 pb-8 flex items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white text-sm font-black rounded-2xl shadow-lg shadow-blue-200 transition-all hover:-translate-y-0.5 disabled:opacity-60 disabled:hover:translate-y-0 disabled:cursor-not-allowed"
                  >
                    {step === 4 ? (
                      isSubmitting ? (
                        <>
